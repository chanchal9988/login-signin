	...
	<div class="wrapper">
		...
		<section class="first-screen section section--no-pad-top" style="background-image: url(./HomeTemplate/crypto/img/main_bg.png);" id="main">
			<div class="container">
				<div class="row">
					<div class="col">
						<h1 data-aos="fade-up" data-aos-anchor="#main" data-aos-delay="200"><?php ahkweb('webname'); ?>  for <span>Real Business</span></h1>
						<p data-aos="fade-up" data-aos-anchor="#main" data-aos-delay="300">
							Archerfish pipefish mora silver hake lumpsucker perch black dragonfish California smoothtongue. Poacher golden trout Atlantic cod
						</p>
						...
						<div class="progress-bar" data-aos="fade-up" data-aos-anchor="#main" data-aos-delay="400">
							...
							<div class="progress-bar__footer">
								<p>Total raised: 1 864 866$</p>
								<p>Fixed token edition 8.000.000 BITS</p>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-lg-6" data-aos="fade-left">
						...
						<p class="text-margin-bot">
							Flabby whalefish longfin smelt panga thornfish silver dollar rockling yellowtail horse mackerel searobin. Buri garpike false trevally Pacific viperfish luminous hake.
						</p>

						<div class="video">
							<a href="https://www.youtube.com/watch?v=0O2aH4XLbto" class="video__btn popup-youtube">
								<img src="./HomeTemplate/crypto/img/play.svg" alt="">
							</a>
							<div class="video__text">Watch Video</div>
						</div>
				...
				<div class="row">
					<div class="col">
						<div class="section-header section-header--center section-header--medium-margin">
							<h4>services</h4>
							<h2><?php ahkweb('webname'); ?> ICO Theme</h2>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6 col-lg-4" data-aos="fade-left" data-aos-delay="200">
						<div class="service-item">
							...
							<div class="service-item__title">General ecosystem</div>
							<p>
								Surf sardine mooneye, sawtooth eel trout-perch, Death Valley pupfish zebra tilapia medaka golden shiner, danio Black angelfish sandperch, whiff. 
							</p>
						</div>
					</div>
					<div class="col-sm-6 col-lg-4" data-aos="fade-left" data-aos-delay="300">
						<div class="service-item">
							...
							<div class="service-item__title">Exchange for other crypto currency</div>
							<p>
								Lemon shark, Blind goby, nibbler mullet, zebra turkeyfish milkfish, goldspotted killifish Jack Dempsey flabby whalefish mud catfish tarwhine Redfin 
							</p>
						</div>
					</div>
					<div class="col-sm-6 col-lg-4" data-aos="fade-left" data-aos-delay="400">
						<div class="service-item">
							...
							<div class="service-item__title">Transfer to Debit card</div>
							<p>
								Man-of-war fish, bighead carp North American darter pejerrey platyfish batfish, pejerrey bocaccio john dory, "zebra shark javelin walleye pollock," 
							</p>
						</div>
					</div>
					<div class="col-sm-6 col-lg-4" data-aos="fade-left" data-aos-delay="500">
						<div class="service-item">
							...
							<div class="service-item__title">Growth of IQeon’s value</div>
							<p>
								Australian prowfish, titan triggerfish wolf-eel pikeblenny creek chub airsac catfish? Shortnose greeneye salmon shark wrymouth largemouth bass 
							</p>
						</div>
					</div>
					<div class="col-sm-6 col-lg-4" data-aos="fade-left" data-aos-delay="600">
						<div class="service-item">
							...
							<div class="service-item__title">Protection against fraud</div>
							<p>
								Ragfish squarehead catfish bristlenose catfish golden loach springfish: triplespine nase trench deepwater stingray. Freshwater eel, pickerel pleco 
							</p>
						</div>
					</div>
					<div class="col-sm-6 col-lg-4" data-aos="fade-left" data-aos-delay="700">
						<div class="service-item">
							...
							<div class="service-item__title">Anonymity</div>
							<p>
								Peter's elephantnose fish toadfish South American darter zebra trout--California halibut gray eel-catfish. Redlip blenny cownose ray sandroller 
							</p>
						</div>
					</div>
				</div>
					...
					<div class="col">
						...
						<div class="col-lg-6 col-xl-5 col-md-8" data-aos="fade-right">
							<div class="section-header section-header--white section-header--tire">
								<h4>Mobile app</h4>
								<h2>Cryptoland App for ICO Platform</h2>
							</div>
				...
				<div class="row" data-aos="fade-up">
					<div class="col-sm-6 col-xl-3">
						<div class="process-item" style="border: 3px solid #16bf86;" >
							...
							<p>Involvement of third-party developers into IQeon ecosystem and expansion of our own product line will lead to growth in users.</p>
					...
					<div class="col-sm-6 col-xl-3">
						<div class="process-item" style="border: 3px solid #5775cf;" >
							...
							<div class="process-item__title">Indefication</div>
							<p>Involvement of third-party developers into IQeon ecosystem and expansion of our own product line will lead to growth in users.</p>
					...
					<div class="col-sm-6 col-xl-3">
						<div class="process-item" style="border: 3px solid #f2718b;">
							...
							<div class="process-item__title">Make payments</div>
							<p>Involvement of third-party developers into IQeon ecosystem and expansion of our own product line will lead to growth in users.</p>
					...
					<div class="col-sm-6 col-xl-3" >
						<div class="process-item" style="border: 3px solid #ff903e;">
							...
							<div class="process-item__title">Buy or sell orders</div>
							<p>Involvement of third-party developers into IQeon ecosystem and expansion of our own product line will lead to growth in users.</p>
						</div>
					</div>
				</div>
