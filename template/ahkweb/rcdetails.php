...
if (isset($_POST['find'])) {
    ...
    if ($wallet_amount > $fee) {
        ...
        $url = "https://$skylineapiurl/serviceApi/V1/Rc-Verification.php?apiKey=$skyline_key&rcno=$rc_no&type=$cardtypeo";
        $curl = curl_init();
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="type" required="" class="form-control">
                                                <option value="">-Select Card-</option>
                                                 <option value="new">CHIP</option>
                                                <option value="old">NO CHIP</option>
                                            </select>
                                        </div>
                                    </div>
                                    </div>
