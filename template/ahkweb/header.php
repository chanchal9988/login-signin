    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <!-- NSDL-Paperless Branch ID START -->
                <li>
                 <li>
                    <a href="javascript:;" class="has-arrow">
                        <div class="parent-icon"><i class="bx bx-id-card"></i>
                        </div>
                        <div class="menu-title">NSDL-Paperless Branch</div>
                    </a>
                    <ul>
                        <li> <a href="nsdl.php"><i class="bx bx-right-arrow-alt"></i>Create NSDL Branch Users</a>
                        </li>
                         <li> <a href="https://pan.panpe.in/Login.aspx"><i class="bx bx-right-arrow-alt"></i>NSDL Branch Login</a>
                        </li>
                        <?php
						if(checkAdmin($udata['type']) == true){
							?>
                        <li> <a href="nsdl_admin_list.php"><i class="bx bx-right-arrow-alt"></i>Branch List For
                                Admin</a>
                        </li>
                        <?php
						}
                ...
                <!-- Aadhar Verification END -->
                
                 <!--All Aadhaar Services Start-->
                <li>
                    <a href="javascript:;" class="has-arrow">
                        <div class="parent-icon"><i class="bx bx-id-card"></i>
                        </div>
                        <div class="menu-title">All Aadhaar Services</div>
                    </a>
                    <ul>
                         <li> <a href="eid_to_aadhaar_no.php"><i class="bx bx-right-arrow-alt"></i>Generated/EDI UID No.</a></li>
                         <li> <a href="duplicates_uid_no.php"><i class="bx bx-right-arrow-alt"></i>Dublicate/EID To UID.</a></li>
                         <li> <a href="complaint_data.php"><i class="bx bx-right-arrow-alt"></i>Complaint/EDI UID NO</a></li>
                         <li> <a href="biometric_issues.php"><i class="bx bx-right-arrow-alt"></i>Biometric Issues UID N.</a></li>
                         <li> <a href="eid_to_aadhaar_pdf.php"><i class="bx bx-right-arrow-alt"></i>Dublicate/EDI To PDF</a></li>
                           <li> <a href="complaint_data_pdf.php"><i class="bx bx-right-arrow-alt"></i>Complaint/EDI To PDF</a></li>
                         <li> <a href="aadhaar_no_to_pdf.php"><i class="bx bx-right-arrow-alt"></i>Find Aadhaar To PDF</a>  </li>
                         <li> <a href="mobile_no_to_pdf.php"><i class="bx bx-right-arrow-alt"></i>Find Mobile No To PDF</a></li>
                         <li> <a href="details_to_aadhaar_pdf.php"><i class="bx bx-right-arrow-alt"></i>Details To Aadhaar PDF</a></li>
                         <li> <a href="complaint_data.php"><i class="bx bx-right-arrow-alt"></i>Pan No To Aadhaar No</a></li>
                         <li> <a href="ration_no_to_aadhaar_no.php"><i class="bx bx-right-arrow-alt"></i>Ration No To UID No</a></li>
                         <li> <a href="LimitCross.php"><i class="bx bx-right-arrow-alt"></i>Aadhaar Limit Cross</a></li>
                    </ul>
                </li>
                 ...
                 <?php
                    ...
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Aadhaar Admin List</div>
                    </a>
                    <ul>
                         <li> <a href="all_edi_to_aadhaar_no_admin_list.php"><i class="bx bx-right-arrow-alt"></i>Find Aadhaar No List</a> </li>
                         <li> <a href="eid_toaadhaar_pdf_admin_list.php"><i class="bx bx-right-arrow-alt"></i>Find Aadhaar PDF List</a> </li>
                         <li> <a href="aadhaar_no_to_pdf_admin_list.php"><i class="bx bx-right-arrow-alt"></i>Aadhaar No To PDF List</a> </li>
                         <li> <a href="mobile_no_to_pdf_admin_list.php"><i class="bx bx-right-arrow-alt"></i>Mobile No To PDF List</a>  </li>
                         <li> <a href="ration_no_to_aadhaar_no_admin_list.php"><i class="bx bx-right-arrow-alt"></i>Ration Aadhaar No List</a> </li>
                         <li> <a href="LimitCrossAdminList.php"><i class="bx bx-right-arrow-alt"></i>Aadhaar L Corss List</a> </li>
                    </ul>
                </li>
                        <?php
						}
               ...
               <!--All Aadhaar Services And-->
                 ...
                 <!--All Pan Card Services And-->
                 
                 <!--All Voter Card Services Start-->
                 <li>
                    <a href="javascript:;" class="has-arrow">
                        <div class="parent-icon"><i class="bx bx-id-card"></i>
                        </div>
                        <div class="menu-title">Voter Card Services</div>
                    </a>
                    <ul>
                        <li> <a href="instant_voter_card_mobile_no_link.php"><i class="bx bx-right-arrow-alt"></i>Instant Mobile No Link</a></li>
                        <li> <a href="vot_org_instant.php"><i class="bx bx-right-arrow-alt"></i>Voter Card Downloads</a></li>
                    </ul>
                </li>
                 ...
                 <?php
                    ...
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Voter Card Admin List</div>
                    </a>
                    <ul>
                         <li> <a href="instant_voter_card_mobile_no_link_admin_list.php"><i class="bx bx-right-arrow-alt"></i>Mobile No Link List</a> </li>
                         <li> <a href="pan_no_to_details_admin_list.php"><i class="bx bx-right-arrow-alt"></i>Voter Card PDF List</a> 
                    </ul>
                </li>
                        <?php
						}
               ...
               <!-- RATION CARD START -->
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">INSTANT RATION PDF</div>
                    </a>
                    <ul>
                        <li> <a href="Ration_Pdf_hkb.php"><i class="bx bx-right-arrow-alt"></i>New Apply</a>
                        </li>
                        <li> <a href="Ration_Pdf_hkb_list.php"><i class="bx bx-right-arrow-alt"></i>Ration List</a>
                        </li>
                        <?php
						if(checkAdmin($udata['type']) == true){
							?>
                        <li> <a href="instant_ration_admin_list.php"><i class="bx bx-right-arrow-alt"></i>List For
                                Admin</a>
                        </li>
                        <?php
						}
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">EPIC NO TO VOTER CARD PDF</div>
                    </a>
                    <ul>
                        <li> <a href="voter.php"><i class="bx bx-right-arrow-alt"></i>New Apply</a>
                        </li>
                        <?php
						if(checkAdmin($udata['type']) == true){
							?>
                        <li> <a href="voter_admin_list.php"><i class="bx bx-right-arrow-alt"></i>List For
                                Admin</a>
                        </li>
                        <?php
						}
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Vaccine Certificate</div>
                    </a>
                    <ul>
                        <li> <a href="vaccine.php"><i class="bx bx-right-arrow-alt"></i>New Apply</a>
                        </li>
                        <?php
						if(checkAdmin($udata['type']) == true){
							?>
                        <li> <a href="vaccine_admin_list.php"><i class="bx bx-right-arrow-alt"></i>List For
                                Admin</a>
                        </li>
                        <?php
						}
