...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://$skylineapiurl/serviceApi/V1/aadhaarVerification.php",
  ...
  CURLOPT_POSTFIELDS => array('bioenc' => $bio,'aadhar' => $aadhar,'apiKey'=>$skyline_key),
...
// If the status is 'N', the balance will not be deducted
  ...
  echo "<script> alert('$error_api Failed' ) 
  ...
  if ( $b[ 'aadharno' ] == $aadharno ) {
   ...
   if($result){
                ...
                <script>
                    ...
                    setTimeout(() => {
                        window.location='aadhar_advance_list.php';
                    }, 1500);
                </script>
                    <?php
 }else{
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input class=" form-control" maxlength="17" id="eno" name="eno" type="text" value="<?php echo $enrollment;?>" >
                  </div>
                </div>
                <?php
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="idate" id="exampleFormControlInput1" placeholder="12/10/2014" value="<?php echo $issueDate;?>" required>
